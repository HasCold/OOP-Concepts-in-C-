#include<iostream>  // <> -->> Angular Brackets;
#include<cstring>
using namespace std; 

// **************** ABSTARCT BASE CLASS AND PURE VIRTUAL FUNCTION *****************

// It is a abstract base class because we included more features in our inherited derived class;
// CWH class bani hi isliye take isse derived hoke aur classes bane;
// basically what is pure virtual function -->> Pure virtual function abstract base class ko banane keliye use hoti ha;
// Note :-->>   IMPORTANT ASPECT;
// Abstract Base class ka matlab hota ha ak aise class jis ko hum objects create krne k liye use nahi karste; 
// iska matlab ke ye design hi is liye ki gayi ha take aur classes inherit kare; Abstract base class aur  pure virtual  
// function ak dosre se related ha;
// Abstract Base Class ma kam se kam ak pure virtual function hota ha;
class CWH{
...
CWH(string s, float r):title(s),rating(r){  // Constructor;
 ...
 virtual void display() = 0; // do-nothing function --> Pure virtual function; (Iska matlab kuch nahi karega);   
// Agr ma virtual likhta hu tab tu derived classes ke apne display() invoke honge lkn agr nahi
